<%-- 
    Document   : google-signup
    Created on : Jan 30, 2021, 10:41:31 AM
    Author     : Delwyn
--%>
                        ...
                        <form action="signUp" method="POST" id="signUpForm" class="md-float-material form-material">
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary"> <input type="text" class="form-control" name="fullname" value="${requestScope.fullname}" placeholder="Full name" id="fullname" readonly> </div>
                                    <div class="form-group form-primary"> <input type="text" class="form-control" name="email" value="${requestScope.email}" placeholder="Email" id="email" readonly> </div>
