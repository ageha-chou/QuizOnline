...
public class UpdateQuestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            WebTarget target = client.target(sUrl).path("updateQuestionAnswer");
            Form form = new Form();
            ...
            form.param("updatedUser", String.valueOf(createdUser));
            form.param("status", status);
            form.param("quesId", questionId);
            ...
            }else session.setAttribute("MESSAGE", "Updated failed!");
        }catch(NotFoundException ex){
            log("UpdateQuestionServlet_NotFound: " + ex.getMessage());
        }finally{
            String urlRewriting = "loadSpecificQues?questId=" + questionId;
